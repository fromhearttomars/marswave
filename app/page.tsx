...
export default function Home() {
  ...
  return (
    <div className="absolute z-10 lg:top-[-40] top-0 left-0 flex flex-col items-center justify-center w-screen h-screen text-white">
      ...
      <div className='h-10'>
        {showSecondText && (
          <div className="transition-opacity duration-1000 ease-in opacity-0 animate-fadeIn lg:text-6xl text-4xl uppercase tracking-wider font-normal">
      ...
      <div className='h-10'>
        {showButtons && (
          <div className="transition-opacity duration-1000 ease-in opacity-0 animate-fadeIn mt-8 flex gap-4">
